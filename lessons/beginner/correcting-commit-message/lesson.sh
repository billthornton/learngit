...
# --------------------------------------
# Having just created a new commit, you realise you have made a typo in the git commit message.
# You haven't shared this commit with anyone else yet (by pushing it), so want to change the message
...
# Lets remove the change to base.html from our staging area (the index) so it is not going to be commited
